...
class EnumHelpersAnnotationProcessorJava9Test {
    ...
    void setUp() {
        ...
        compiler = Compiler.javac()
                .withProcessors(EnumHelpersAnnotationProcessor.create(SourceVersion.latest(), () -> generationTime));
    }
    ...
    void defaultAnnotationConfiguration() throws IOException {
        assertThat(compiler.compile(JavaFileObjects.forResource("annotated/EnumHelper/Simple.java")))
                ...
                .isEqualTo(JavaFileObjects.forResource("expected/EnumHelper/java9/Simples.java").getCharContent(false));
    }
}